/**
 * API: Cập nhật sức khỏe quân nhân
 * PATCH /api/soldier-profile/[id]/health
 */
...
export async function PATCH(
  ...
  try {
    ...
    if (!existing) {
      return NextResponse.json({ error: 'Soldier profile not found' }, { status: 404 });
    }
    ...
    console.error('Error updating soldier health:', error);
