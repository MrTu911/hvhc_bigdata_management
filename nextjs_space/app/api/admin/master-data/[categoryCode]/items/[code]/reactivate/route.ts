 ...
 * Re-activates a previously deactivated item.
 * Guards: category must still be active; if item has a parentCode, the parent must be active too.
 */
...
export async function POST(req: NextRequest, { params }: Ctx) {
  try {
    ...
    // toggleItemStatus reactivates if currently inactive, checks parent constraints
    ...
    console.error('[POST reactivate]', e)
