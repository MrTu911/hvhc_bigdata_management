...
RUN_PRISMA_PUSH="${RUN_PRISMA_PUSH:-1}"  # dùng khi RESET_MODE=dropdb
...
print_summary() {
  ...
  log "3. Master data / Administrative / Danh mục"
  log "4. Personnel / Faculty"
  log "5. Party organizations / members / histories / activities"
  log "6. Education / Teaching"
  log "7. Policy / Thi đua / Khen thưởng / Kỷ luật"
  log "8. Insurance / BHXH / BHYT"
  log "9. Scientific / Demo mở rộng / Backfill"
}
